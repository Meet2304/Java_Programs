...
def load_data():
   with st.spinner(text="Loading and indexing the Documents – hang tight! This should take 1-2 minutes."):
       ...
       llm = Gemini(api_key='AIzaSyAjCSF4sb4YUHwe51YlrYzVy8gtxDfJWuI')
       embed_model = GeminiEmbedding(api_key='AIzaSyAjCSF4sb4YUHwe51YlrYzVy8gtxDfJWuI')  # Fix typo
...
if "chat_engine" not in st.session_state.keys():
   ...
   llm = ChatGoogleGenerativeAI(model="gemini-pro", google_api_key='AIzaSyAjCSF4sb4YUHwe51YlrYzVy8gtxDfJWuI', temperature=0)
