 ...
 * UNCHECKED Exception. Exception must be thrown from the constructor of 
 * the Box class if either of the dimension from length, width or height is zero or less than zero.
 * Demonstrate in main.
 */


// if the question is to write a checked exception, the class should extend Exception instead of RuntimeException
